...
<?php 
$desc = $content['body'];
$feature = $content['field_phone_feature'];
$spec = $content['field_specs'];
$review = $content['field_reviews'];
$brand = $content['field_brand'];
$carrier = $content['field_carrier'];
$category = $content['field_features'];
$pics = $content['field_image'];
$carrier_logo = $content['field_carrier_logo'];
?>
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <?php 
         ...
         ?>
         <div class="read-more">
           <button class="btn btn-default">See more details</button>
         </div>
      </div>
    </div>
